...
// NOTE: This struct is accessible only within the parent module,
// so we don't have to worry about the fields and methods being public.
// FIXME: A number of owned strings should be borrows here.
pub(super) struct SpacesRequestBuilder {
